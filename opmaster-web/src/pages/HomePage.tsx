...
import { 
  ...
  Palette, Layers, Zap, ChevronRight, Globe, Users, Settings, Sliders
} from 'lucide-react';
    ...
    <div className="animate-pulse">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-16 pb-12">
        <div className="text-center mb-12">
          <div className="w-32 h-4 bg-bg-secondary rounded-full mx-auto mb-6" />
          <div className="w-56 h-10 bg-bg-secondary mx-auto mb-3" />
          <div className="w-64 h-4 bg-bg-secondary mx-auto mb-2" />
          <div className="w-48 h-4 bg-bg-secondary mx-auto mb-8" />
          <div className="flex items-center gap-4 justify-center">
            <div className="w-36 h-12 bg-bg-secondary rounded-2xl" />
            <div className="w-32 h-12 bg-bg-secondary rounded-2xl" />
          </div>
        </div>
        
        {/* Photos Skeleton */}
        <div className="grid grid-cols-4 gap-3.5 max-w-2xl mx-auto mb-14">
          {[1,2,3,4].map(i => (
            <div key={i} className="aspect-square rounded-2xl bg-bg-secondary" />
          ))}
        </div>
        
        {/* Quick Actions Skeleton */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5 sm:gap-4 mb-16">
          {[1,2,3,4].map(i => (
            <div key={i} className="h-36 bg-bg-secondary rounded-2xl" />
          ))}
        </div>
      </div>
    </div>
            ...
            <div className="pt-20 px-6 pb-24">
              ...
              >
                {[
                  ...
                  { name: '云同步', path: '/cloud-sync', icon: Globe },
                  { name: '订阅管理', path: '/subscription', icon: Settings },
                ].map((item, index) => (
                  <motion.button
                    key={item.path}
                  ...
                  >
                    ...
                    <span className="text-h3 font-semibold text-text-primary">{item.name}</span>
                  </motion.button>
                ))}
              </motion.div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                  ...
                  >
                    ...
                    <motion.h1
                      ...
                      className="text-display font-bold mb-4 leading-tight"
                    >
                  ...
                  >
                    {quickActions.map((action, index) => (
                      <motion.button
                        ...
                        className="bg-neutral-800/50 backdrop-blur-xl border border-white/10 rounded-2xl p-4.5 sm:p-5 flex flex-col items-center gap-3.5 hover:bg-white/10 transition-all duration-300 ease-out-elastic"
                      ...
                      >
                        ...
                        <div className="text-center">
                          <span className="text-body2 font-bold text-text-primary block">{action.label}</span>
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1.5 px-4 py-2.5 rounded-full text-body2 font-medium whitespace-nowrap transition-all duration-300 ease-out-elastic ${
                          activeCategory === category.id
                            ...
                            : 'bg-neutral-800 text-text-secondary hover:text-text-primary hover:bg-neutral-700'
                        }`}
                      >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
                    {featureCards.map((card, index) => (
                      <motion.div
                        ...
                        className="bg-neutral-800/70 border border-white/10 rounded-2xl p-6 sm:p-7 cursor-pointer hover:border-oppo-orange/20 transition-all duration-300 ease-out-elastic shadow-oppo-elevation-1"
                      >
                        ...
                        <h3 className="text-h2 font-bold mb-2 text-text-primary">{card.title}</h3>
              ...
              <section className="section-padding">
                <div className="max-w-7xl mx-auto px-4">
                  <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="relative overflow-hidden rounded-3xl bg-bg-glass backdrop-blur-2xl border border-white/10 p-7 sm:p-9"
                  >
                    {/* 背景渐变 */}
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                      <div className="flex-1 text-center lg:text-left">
                        ...
                        <h2 className="text-h1 sm:text-display font-bold mb-4 text-text-primary">
                          AI场景识别 · 666种
                        </h2>
              ...
              <section className="section-padding pb-12">
                <div className="max-w-xl mx-auto text-center px-4">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <h2 className="text-display font-bold mb-4 text-text-primary">准备好开始了吗？</h2>
