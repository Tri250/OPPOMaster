...
export default function AppShowcase() {
  ...
  const features = [
    ...
    { icon: Sparkles, title: 'AI智能推荐', desc: '场景识别，自动匹配最佳参数', color: 'text-aurora-purple' },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.h1
                custom={1} variants={sectionVariants}
              ...
              <motion.p
                custom={2} variants={sectionVariants}
              ...
              <motion.div
                custom={3} variants={sectionVariants}
              ...
              <motion.div
                custom={4} variants={sectionVariants}
