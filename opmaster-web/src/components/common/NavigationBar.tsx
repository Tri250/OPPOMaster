    ...
    >
            ...
            <div className="relative">
              ...
              {showFeatures && (
                <motion.div
                  ...
                  className="absolute top-full right-0 mt-2 w-48 bg-card-surface rounded-oppo-md border border-oppo-border/50 shadow-xl overflow-hidden"
                >
      ...
      {isOpen && (
        <motion.div
          ...
          className="md:hidden bg-card-surface border-t border-oppo-border/50"
        >
