...
class CloudSyncManager @Inject constructor(
    ...
    private fun serializePresetsToJson(presets: List<Preset>): String {
        ...
        presets.forEachIndexed { index, preset ->
            ...
            sb.append("        \"mode\": \"${preset.cameraParams.mode}\",\n")
            sb.append("        \"iso\": ${preset.cameraParams.iso},\n")
            sb.append("        \"shutter\": \"${preset.cameraParams.shutter}\",\n")
            sb.append("        \"ev\": \"${preset.cameraParams.ev}\",\n")
            sb.append("        \"wb\": \"${preset.cameraParams.wb}\",\n")
            sb.append("        \"filter\": \"${preset.cameraParams.filter}\"\n")
            sb.append("      }\n")
            sb.append("    }")
